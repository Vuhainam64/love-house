            ...
            >
              {({ values, errors, touched, setFieldValue }) => (
                <Form>
                  ...
                  <Field name="quotationId" as={Input} type="text" readOnly className="mb-3"/>

                  <label htmlFor="materialDiscount">
                    Material Discount
                  </label>
                  <Field name="materialDiscount" as={Input} type="number" className="mb-3"/>
                  ...
                  <Field name="furnitureDiscount" as={Input} type="number" className="mb-3"/>
                  ...
                  {errors.laborDiscount && touched.laborDiscount && (
                    <div style={{ color: "red", marginBottom:"12px" }}>{errors.laborDiscount}</div>
                  )}
